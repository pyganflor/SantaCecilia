...
class propagConfiguracionesController extends Controller
{
    ...
    public function form_variedades(Request $request)
    {
        $contenedores = ContenedorPropag::All()->where('estado', 1)->sortBy('nombre');
        return view('adminlte.gestion.propagacion.configuraciones.forms.form_variedades', [
    ...
    public function actualizar_variedad(Request $request)
    {
        ...
        $model->id_contenedor_propag = $request->cont_propag;
        $model->save();
        return [
            'success' => true,
            'mensaje' => '',
