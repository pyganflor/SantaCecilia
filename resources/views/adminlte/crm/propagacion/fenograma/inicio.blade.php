            ...
            <div class="col-md-4">
                <div class="form-group input-group">
                    ...
                    <select name="filtro_predeterminado_variedad" id="filtro_predeterminado_variedad" class="form-control input-yura_default"
                            onchange="filtrar_ciclos_fenograma_propag()">
            ...
            <div class="col-md-4">
                <div class="form-group input-group">
                    ...
                    <input type="date" class="form-control input-yura_default" id="filtro_predeterminado_fecha"
                           name="filtro_predeterminado_fecha" required value="{{date('Y-m-d')}}" onchange="filtrar_ciclos_fenograma_propag()">
                    <div class="input-group-btn">
                        <button type="button" class="btn btn-yura_primary" onclick="filtrar_ciclos_fenograma_propag()">
