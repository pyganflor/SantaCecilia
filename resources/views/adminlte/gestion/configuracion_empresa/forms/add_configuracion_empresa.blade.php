        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group input-group">
                    ...
                    <input type="text" id="permiso_agrocalidad" name="permiso_agrocalidad" class="form-control" maxlength="50"
            ...
            <div class="col-md-6">
                <div class="form-group input-group">
                    ...
                    <input type="text" id="codigo_etiqueta_empresa" name="codigo_etiqueta_empresa" class="form-control"
                           minlength="1" value="{!! isset($config_empresa->codigo_etiqueta_empresa) ? $config_empresa->codigo_etiqueta_empresa : "" !!}">
                </div>
            </div>
        </div>
        <hr/>
