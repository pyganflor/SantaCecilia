    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group input-group">
                ...
                <input type="text" id="permiso_agrocalidad_empresa_facturacion" name="permiso_agrocalidad_empresa_facturacion" class="form-control" maxlength="50"
        ...
        <div class="col-md-4">
            <div class="form-group input-group">
                ...
                <input type="file" id="firma_electronica_empresa_facturacion" name="firma_electronica_empresa_facturacion" accept="application/x-pkcs12" class="form-control">
        ...
        <div class="col-md-6">
            <div class="form-group input-group">
                ...
                <input type="text" id="codigo_etiqueta_empresa_facturacion" name="codigo_etiqueta_empresa_facturacion" class="form-control"
                       minlength="1" value="{!! isset($config_empresa_facturacion->codigo_etiqueta_empresa) ? $config_empresa_facturacion->codigo_etiqueta_empresa : "" !!}">
            </div>
        </div>
