<table class="table-striped table-bordered" style="width: 100%; border: 1px solid #9d9d9d; border-radius: 18px 18px 0 0"
    ...
    <tr id="tr_fijo_top_0">
        <th class="text-center th_fijo_left_0 th_yura_green"
            style="border-radius: 18px 0 0 0; background-color: #00B388 !important; z-index: 10 !important;">
        ...
        @foreach($semanas as $pos_s => $sem)
            ...
            @php
                $total_mo += $totales_costos_mo[$pos_s]->valor;
                $totales_personal[] = 0;
            @endphp
        @endforeach
    ...
    <tr>
        <th class="text-center th_fijo_left_0" style="background-color: #e9ecef; border-color: #9d9d9d">
            <span style="margin: auto 5px; color: black; font-weight: bold; font-size: 0.85em" class="btn btn-xs btn-link"
                  onclick="$('.tr_centro_costos').toggleClass('hidden')">
                CENTROS DE COSTOS
            </span>
        </th>
        <td colspan="{{count($semanas) + 1}}" style="background-color: #e9ecef; border-color: #9d9d9d"></td>
    </tr>
    @include('adminlte.gestion.costos.generales.partials._centro_costos')
    {{-- TOTAL COSTOS --}}
    <tr>
        <th class="text-center th_fijo_left_0" style="background-color: #e9ecef; border-color: #9d9d9d">
            <span style="margin: auto 5px; color: black; font-weight: bold; font-size: 0.85em" class="btn btn-xs btn-link"
    ...
    <tr id="tr_fijo_bottom_0">
        <th class="text-center th_fijo_left_0" style="background-color: #e9ecef; border-color: #9d9d9d; z-index: 8 !important;">
            <span style="margin: auto 5px; color: black; font-weight: bold; font-size: 0.85em;">
                EBITDA
            </span>
        </th>
    ...
    @include('adminlte.gestion.costos.generales.partials._rrhh')
    {{-- OTROS INDICADORES --}}
    <tr>
        <th class="text-center th_fijo_left_0" style="background-color: #e9ecef; border-color: #9d9d9d">
            <span style="margin: auto 5px; color: black; font-weight: bold; font-size: 0.85em" class="btn btn-xs btn-link"
    ...
    @include('adminlte.gestion.costos.generales.partials._row_unosoft')
</table>
