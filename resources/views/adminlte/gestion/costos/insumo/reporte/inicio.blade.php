    ...
    <section class="content">
        <div class="input-group">
            ...
            <div class="input-group-btn">
                <button type="button" class="btn btn-yura_dark" title="Buscar" onclick="listar_reporte_insumos()">
                    <i class="fa fa-fw fa-search"></i>
                </button>
                <button type="button" class="btn btn-yura_primary" title="Exportar" onclick="exportar_reporte_insumos()">
        ...
        <div class="row" style="margin-top: 10px">
            <div class="col-md-3 div_content_fixed">
                @include('adminlte.gestion.costos.insumo.reporte.partials.areas_actividades')
            </div>
...
@section('script_final')
    <script>
        $('#vista_actual').val('reporte_insumos');

        listar_reporte_insumos();

        function exportar_reporte_insumos() {
            $.LoadingOverlay('show');
            window.open('{{url('reporte_insumos/exportar_reporte_insumos')}}?area=' + $('#area_seleccionada').val() +
