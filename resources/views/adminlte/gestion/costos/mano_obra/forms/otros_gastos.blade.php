<table class="table-striped table-bordered table-hover" width="100%" style="border: 2px solid #9d9d9d;">
    ...
    <tr>
        ...
        <td class="text-center" style=" border-color: #9d9d9d">
            <input type="number" id="codigo_semana" name="codigo_semana" max="{{$semana_actual}}"
    ...
    <tr>
        ...
        <td class="text-center" style=" border-color: #9d9d9d">
            <input type="text" id="regalias" name="regalias" value="{{isset($otros_gastos) ? $otros_gastos->regalias : 0}}" style="width: 100%"
                   class="text-center input_search">
        </td>
    </tr>
    <tr>
