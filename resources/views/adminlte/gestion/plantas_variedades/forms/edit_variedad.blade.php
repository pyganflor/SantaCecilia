<form id="form_edit_variedad">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <legend class="text-center" style="font-size: 1em">Datos para importaciones</legend>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="nombre_unosoft">Nombre unosoft</label>
                <input type="text" id="nombre_unosoft" name="nombre_unosoft" class="form-control" value="{{$variedad->nombre_unosoft}}"
                       placeholder="{{$variedad->nombre}}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
