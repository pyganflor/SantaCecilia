    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select disabled id="codigo_impuesto" name="codigo_impuesto" class="form-control" required onchange="porcentaje_impuesto()">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select disabled id="tipo_impuesto" name="tipo_impuesto" class="form-control" required>
                    <option selected disabled>Seleccione</option>
