                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            ...
                            <div class="input-group pull-right">
                                <select name="filtro_planta" id="filtro_planta" class="input-yura_white"
                                        onchange="select_planta($(this).val(), 'variedad_ciclos', 'variedad_ciclos', '<option>Seleccione tipo</option>')">
                                    <option value="">Seleccione variedad</option>
                                    @foreach(getPlantas() as $p)
                                        <option value="{{$p->id_planta}}">{{$p->nombre}}</option>
                                    @endforeach
                                </select>
                                <select name="variedad_ciclos" id="variedad_ciclos" onchange="listar_ciclos_propag()" class="border-radius_18">
                                </select>
                                <select name="activo_ciclos" id="activo_ciclos" onchange="listar_ciclos_propag()" class="border-radius_18">
