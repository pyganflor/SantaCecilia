<table class="table-bordered table-striped" style="width: 100%; border: 2px solid #9d9d9d; border-radius: 18px 18px 0 0" id="table_camas">
    <thead>
    <tr>
        <th class="text-center th_yura_green" style="border-color: white; border-radius: 18px 0 0 0">Finca</th>
        <th class="text-center th_yura_green" style="border-color: white;">Área</th>
        ...
        <th class="text-center th_yura_green" style="border-color: white; width: 60px; border-radius: 0 18px 0 0">
            <div class="btn-group">
                <button type="button" class="btn btn-xs btn-default btn-yura_default" onclick="listar_camas_propag()" title="Actualizar listado">
    ...
    @foreach($camas as $c)
        <tr class="{{$c->estado == 0 ? 'error' : ''}}">
            <td class="text-center td_yura_default" style="border-color: #9d9d9d">{{$c->empresa->nombre}}</td>
