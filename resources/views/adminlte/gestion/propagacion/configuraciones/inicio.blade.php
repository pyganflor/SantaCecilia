    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs-justified nav-justified">
                <li class="active"><a href="#tab_contenedores" data-toggle="tab" aria-expanded="true">Bandejas</a></li>
                <li><a href="#tab_variedades" data-toggle="tab" aria-expanded="true" onclick="form_variedades()">Variedades</a></li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab_variedades">
