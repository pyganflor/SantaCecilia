<table class="table-bordered table-striped" style="width: 100%; border: 2px solid #9d9d9d; border-radius: 18px 18px 0 0" id="table_contenedores">
    ...
    <tr>
        ...
        <th class="text-center th_yura_green" style="border-color: white;">Sustrato x Banddeja</th>
    ...
    @foreach($contenedores as $c)
        <tr class="{{$c->estado == 0 ? 'error' : ''}}" onmouseover="$(this).addClass()">
            ...
            <td class="text-center td_yura_default" style="border-color: #9d9d9d">0</td>
            <td class="text-center td_yura_default" style="border-color: #9d9d9d">
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-xs btn-primary" onclick="asignar_variedades('{{$c->id_contenedor_propag}}')">
