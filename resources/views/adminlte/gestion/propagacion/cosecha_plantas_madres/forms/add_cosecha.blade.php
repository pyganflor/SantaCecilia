<div class="box box-success">
    ...
    <div class="box-body text-center">
        @if(count($camas) > 0)
            <table class="table-bordered" id="table_form_add_cosecha" style="width: 100%; border: 1px solid #9d9d9d; border-radius: 18px 0 0 0">
                ...
                <tr id="tr_add_cosecha_1">
                    ...
                    <td class="text-center" style="border-color: #9d9d9d;">
                        <input type="number" onkeyup="return isNumber(event)" id="cantidad_add_cosecha_1" style="width: 100%"
                               class="text-center">
                    </td>
        ...
        @else
            <div class="alert alert-info text-center">No se han ingresado camas para esta finca</div>
        @endif
    </div>
</div>