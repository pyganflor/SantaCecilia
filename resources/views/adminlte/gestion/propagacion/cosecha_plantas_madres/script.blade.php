<script>
    $('#vista_actual').val('cosecha_plantas_madres');
    ...
    function listar_cosechas() {
        ...
        $.get('{{url('cosecha_plantas_madres/listar_cosechas')}}', datos, function (retorno) {
            ...
            $('#table_cosechas_filter>label>input').addClass('input-yura_default');
            $('#table_cosechas_length>label>select').addClass('input-yura_default');
    ...
    function select_cama(num_form) {
        ...
        if (datos['cama'] != null) {
            ...
            $.post('{{url('cosecha_plantas_madres/select_cama')}}', datos, function (retorno) {
                $('#td_variedad_add_cosecha_' + num_form).html(retorno.variedad['nombre']);
