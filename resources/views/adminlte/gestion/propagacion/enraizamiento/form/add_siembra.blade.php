    ...
    <div class="box-body text-center">
        <table style="width: 100%; border: 1px solid #9d9d9d" id="table_form_add">
            <tr>
                ...
                <th class="text-center th_yura_green" style="border-color: white;">Bandeja</th>
            ...
            <tr id="row_form_add_1">
                ...
                <td class="text-center div_cargar_semanas_1">
                    <select style="width: 100%" id="form_add_contenedor_1">
                        @foreach($contenedores as $cont)
                            <option value="{{$cont->id_contenedor_propag}}">{{$cont->nombre}}</option>
                        @endforeach
                    </select>
                </td>
                <td class="text-center">
