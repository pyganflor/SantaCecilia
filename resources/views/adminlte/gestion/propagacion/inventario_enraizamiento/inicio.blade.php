...
@section('contenido')
    ...
    <section class="content">
                ...
                <td style="padding-left: 5px">
                    ...
                    <span class="input-group-addon span-input-group-yura-fixed bg-yura_dark">
                        ...
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-yura_primary" onclick="listar_inventario_enraizamiento()">
        ...
        <div id="listado_inventario"></div>
    </section>
@endsection

@section('script_final')
    @include('adminlte.gestion.propagacion.inventario_enraizamiento.script')
@endsection