    ...
    <section class="content">
            ...
            <div class="col-md-3">
                <div class="form-group input-group">
                    ...
                    <input type="number" class="form-control input-yura_default" id="filtro_predeterminado_desde"
                           name="filtro_predeterminado_desde" required readonly
            ...
            <div class="col-md-3">
                <div class="form-group input-group">
                    ...
                    <span class="input-group-btn">
                        <button type="button" class="btn btn-yura_primary" onclick="listar_proyecciones_cosecha()">
        ...
        <div class="input-group" style="display: none">
            ...
            <select class="form-control" id="filtro_predeterminado_opciones" name="filtro_predeterminado_opciones" required
                    onchange="listar_proyecciones_cosecha()">
