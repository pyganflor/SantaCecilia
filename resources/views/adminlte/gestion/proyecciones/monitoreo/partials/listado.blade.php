<div style="overflow-x: scroll; overflow-y: scroll; max-height: 450px">
    <table class="table-striped table-bordered" style="width: 100%; border: 1px solid #9d9d9d; font-size: 0.9em">
        <tr class="tr_fija_top_0">
            <th class="text-center th_fijo_left_0 background-color_yura" style="border-color: #9d9d9d; color: white; z-index: 99 !important;">
                <div style="width: 70px">
                    Módulo
                </div>
            </th>
            <th class="text-center background-color_yura" style="border-color: #9d9d9d; color: white; z-index: 9">
                <div style="width: 70px">
                    Semana Fen.
                </div>
            </th>
        ...
        @foreach($ciclos as $pos => $item)
            @php
                ...
                $num_sem = intval(difFechas($item['ciclo']->fecha_inicio, date('Y-m-d'))->days / 7);
            @endphp
            ...
            <tr class="{{$num_sem >= $min_semanas && ($modulo->id_sector == $sector || $sector == 'T') ? '' : 'hide'}}">
                ...
                <th class="text-center th_yura_default" style="border-color: #9d9d9d; background-color: #e9ecef !important;">
                    {{$num_sem}}
                </th>
                @php
                    $ant = 0;
