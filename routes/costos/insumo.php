...
Route::get('reporte_insumos/exportar_reporte_insumos', 'Costos\CostosController@exportar_reporte_insumos');
Route::post('reporte_insumos/corregir_costos_insumos', 'Costos\CostosController@corregir_costos_insumos');
