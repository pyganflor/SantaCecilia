...
Route::get('db_indicadores/listar_indicadores', 'dbController@listar_indicadores');
Route::post('db_indicadores/copiar_indicador', 'dbController@copiar_indicador');
...
Route::post('intervalo_indicador/update_objetivos', 'dbController@update_objetivos');
