...
Route::get('propag_config/form_variedades', 'Propagacion\propagConfiguracionesController@form_variedades');
Route::post('propag_config/actualizar_variedad', 'Propagacion\propagConfiguracionesController@actualizar_variedad');