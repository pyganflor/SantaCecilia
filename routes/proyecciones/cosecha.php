...
Route::post('proy_cosecha/actualizar_proyecciones_job', 'Proyecciones\proyCosechaController@actualizar_proyecciones_job');
Route::get('proy_cosecha/new_cultivo', 'Proyecciones\proyCosechaController@new_cultivo');
Route::post('proy_cosecha/store_new_cultivo', 'Proyecciones\proyCosechaController@store_new_cultivo');
