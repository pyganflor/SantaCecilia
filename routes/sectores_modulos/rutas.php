...
Route::get('sectores_modulos/listar_sectores_modulos', 'SectorController@listar_sectores_modulos');
...
Route::get('sectores_modulos/crear_activar_modulo', 'CiclosController@crear_activar_modulo');
Route::post('sectores_modulos/store_crear_activar_modulo', 'CiclosController@store_crear_activar_modulo');
Route::get('sectores_modulos/buscar_modulos_inactivos', 'CiclosController@buscar_modulos_inactivos');